				  ...
				  <nav class="navbar navbar-expand-lg navbar-light bg-light">
					...
					<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
						<div class="navbar-nav">
							...
							<a class="nav-item nav-link " href="/kondisi" >kondisi</a>
							<a class="nav-item nav-link " href="/ruang" >ruang</a>
							<a class="nav-item nav-link " href="/unit" >unit</a>
							<a class="nav-item nav-link " href="/gambar" >gambar</a>
							<a class="nav-item nav-link " href="/kopiproduk" >kopiproduk</a>
						</div>
					</div>
				</nav>
			  </div>
